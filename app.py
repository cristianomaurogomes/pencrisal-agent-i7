...
# ============================================================
# 3. APLICAR LORA MANUALMENTE (SEM PEFT)
# ============================================================
def apply_lora_manually(model, adapter_dir):
    """Aplica os pesos LoRA diretamente aos módulos do modelo base."""
    # Carrega os pesos LoRA
    ...
    # Itera sobre os módulos alvo e aplica os pesos
    ...
    for name, param in model.named_parameters():
        # Verifica se o nome do parâmetro corresponde a um módulo LoRA
        # Exemplo: "model.layers.0.self_attn.q_proj.weight"
        for target in target_modules:
            if f".{target}." in name and "weight" in name:
                # Extrai o nome base do módulo
                base_name = name.replace(".weight", "")
                # Carrega os pesos LoRA correspondentes
...
def carregar_modelo():
    with st.spinner("🔄 Carregando modelo..."):
        ...
        # Carrega a cabeça de classificação
