...
@st.cache_resource
def baixar_modelo():
    # 🔥 SEU ID DA PASTA NO GOOGLE DRIVE
    ...
    with st.spinner("🔄 Baixando modelo do Google Drive... (até 3 minutos)"):
        ...
        # Move os arquivos para o local esperado
        os.makedirs("./adapter", exist_ok=True)
        
        # Move a pasta adapter
        if os.path.exists("./temp_drive/adapter"):
            shutil.copytree("./temp_drive/adapter", "./adapter", dirs_exist_ok=True)
        
        # Move o classification_head.pt (pode estar na raiz ou dentro de uma subpasta)
        if os.path.exists("./temp_drive/classification_head.pt"):
            shutil.copy2("./temp_drive/classification_head.pt", "./classification_head.pt")
        elif os.path.exists("./temp_drive/pencrisal_modelo/classification_head.pt"):
            shutil.copy2("./temp_drive/pencrisal_modelo/classification_head.pt", "./classification_head.pt")
